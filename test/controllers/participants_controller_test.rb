...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { code: @participant.code, name: @participant.name, organization: @participant.organization } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { code: @participant.code, name: @participant.name, organization: @participant.organization } }
